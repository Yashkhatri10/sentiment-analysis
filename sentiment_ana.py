...
def wordcloud():
    df = pd.read_csv(r"C:\Users\Hp\Desktop\model\Twitter_Data.csv")
...
def load():
    if os.path.exists(r"C:\Users\Hp\Desktop\model\model.joblib"):
        global classifier 
        classifier= joblib.load(r"C:\Users\Hp\Desktop\model\model.joblib")
        global vect 
        vect = joblib.load(r"C:\Users\Hp\Desktop\model\ect.joblib")
